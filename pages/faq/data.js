export const FAQs = [
  ...
  {
    id: 3,
    question: 'What are ToNote’s working hours?',
    answer: `
    <div>
    ...
    <i>Note that all sessions are subject to availability of active notaries public. If your request is for an immediate session, you will be placed on a queue and connected with the next available notary on a first come first serve basis.</i></div>`
  },
  {
    id: 4,
    question: 'Is e-notarisation by ToNote legal in the country?',
    answer: `
    <div>
  ...
  {
    id: 5,
    question: 'Is notarising on ToNote different from the traditional notarisation?',
    answer: `
    <div>
    ...
    list: {
      content: [
        'No physical presence is required to get a document notarised. This can be done at the comfort of your home or office via a video call between you, the notary public and third parties (where necessary).',
        'You and the notary public can now sign, notarise and share documents digitally',
        'As a notary public, you can digitise your physical stamps and seals on the platform.',
        'A digital certificate highlighting all time and personnel related details of each transaction is attached to each notarised document.',
  ...
  {
    id: 6,
    question: 'Does ToNote use certified notary publics?',
    answer: `
    <div>
  ...
  {
    id: 7,
    question: 'How safe is ToNote with my personal information and contracts? ',
    answer: `
    <div>
  ...
  {
    id: 8,
    question: 'What are the acceptable forms of ID on ToNote?',
    answer: `
    <div>
  ...
  {
    id: 9,
    question: 'How much does it cost to get a document notarised?',
    answer: `
    <div>
    <p>Different types of documents may require different notarisation fees. 
    Our pricing is as follows:</p><br/>
    </div>`,
    footer: '<p>Depending on the outcome of a notary session, additional costs may apply.</p>'
  },
  {
    id: 10,
    question: 'What type of document(s) can be signed and notarised on ToNote?',
    answer: `<div>
    <p>Any document that requires a signature witness can be prepared, signed and shared on the ToNote platform.</p><br/>
    <p>Some of the most frequently notarised documents are:</p></div>`,
    list: {
      type: 'unordered',
      content: [
  ...
  {
    id: 11,
    question: 'Can I sign, send or notarise documents outside the country?',
    answer: `
    <div>
  ...
  },
  {
    ...
    list: {
      ...
      content: [
        ...
        'Profile completion monitor and account verification to ensure every user is authenticated and traceable (you will always be informed when a third party user is not verified)',
  ...
  {
    id: 13,
    question: 'How can I verify the authenticity of a shared document on ToNote?',
    answer: `
    <div>
  ...
  {
    id: 14,
    question: 'What are the various subscription plans?',
    answer: `
    <div>
  ...
  {
    id: 15,
    question: 'How do I migrate from my current plan?',
    answer: `
    <div>
  ...
  {
    id: 16,
    question: 'I have a question about the contents of the document or errors in the document, whom do I contact?',
    answer: `
    <div>
  ...
  {
    id: 17,
    question: 'Upload document issues',
    answer: `
    <div>
    ...
    list: {
      type: 'unordered',
      content: [
        'It exceeds 50MB or contains more than 500 pages',
        'It is a .doc, .xls or .ppt. We support .pdf, …..(All document types should be accepted but will automatically convert to PDF.'
      ]
    }
  },
  {
    id: 18,
    question: 'Download document issues',
    answer: `
    <div>
  ...
  {
    id: 19,
    question: 'How do I know who sent me a document or note?',
    answer: '<div><p>The notification email contains the sender name and their email address.</p></div>'
  },
  {
    id: 20,
    question: 'How do I download documents or notes from my account?',
    answer: `
    <div><p>Here is how to download documents or notes from your account:</p></div>`,
    list: {
      type: 'ordered',
      content: [
        'Log in to your ToNote account',
        'Search for the document in the search box',
        'You can download a document if it is available in your locker'
      ]
    }
  },
  {
    id: 21,
    question: 'How do I download or print a completed document?',
    answer: '<div><p>Here is how to download documents or notes from your account:</p></div>',
    list: {
      type: 'ordered',
      content: [
        'Log in to your ToNote account',
        'Search for the document in the search box',
        'You can download a document if it is available in your locker',
        'ToNote encourages a greener environment and advises users to share documents electronically to trusted recipients as opposed to printing paper copies.'
      ]
    }
  },
  {
    id: 22,
    question: 'As a notary public, how do I get started on ToNote?',
    answer: '<div><p>Start earning with ToNote by following these steps:</p></div>',
    list: {
      type: 'ordered',
      content: [
        'Visit the ‘ToNote for Notaries Public’ tab on our web platform',
        'Sign up and input the required personal information',
        'Upload your ID and Notary certificate or Sworn oath of office documentation',
        'Once your credentials are verified you will be alerted and you can take part in a short Remote Online Notarisation training course and assessment',
        'Digitise your notary stamp, seal and signature automatically',
        'Ensure you have an internet enabled device with audio and video capabilities',
        'Select your preferred schedule for notary sessions',
        'Start earning'
      ]
    }
  },
  {
    id: 23,
    question: 'What is the maximum number of signers ToNote can accommodate?',
    answer: `
    <div>
  ...
  {
    id: 24,
    question: 'Can I get my notarised document physically sent to my address?',
    answer: '<div><p>No, you cannot get your notarised document sent to you but you can print and download the notarised document.</p></div>'
  },
  {
    id: 25,
    question: 'How can a recipient of a notarised document verify a Notarised transaction?',
    answer: `
    <div>
  ...
  {
    id: 26,
    question: 'How do I make my signature electronic? Or how do I upload my electronic signature on ToNote? ',
    answer: `
    <div>
    ...
    <a style="text-decoration:underline;" href="/contact-sales" target="_blank">CONTACT SALES</a>.</p></div>`
  },
  {
    id: 27,
    question: 'Do I have to Use Video Conferencing during a Notary session?',
    answer: '<div><p>Yes! An important requirement for notarisation as stipulated by law is that you must appear or be seen in person. Live video conferencing in real time during your e-notary session makes the process credible.</p></div>'
  },
  {
    id: 28,
    question: 'How can I test my webcam?',
    answer: '<div><p>The easiest way to test your webcam is by clicking on ‘Test My Webcam’ when joining or starting a notary session. This will walk you through to make sure everything is set up correctly.</p></div>'
  },
  {
    id: 29,
    question: 'Can you notarise a document that is not written in English?',
    answer: '<div><p>Not at this time. Please translate your document into English before uploading or simply use available templates on our platform.</p></div>'
  },
  {
    id: 30,
    question: 'What type of payments do you accept?',
    answer: '<div><p>Our system accepts all major credit cards, payment by transfer and USSD.</p></div>'
  },
  {
    id: 31,
