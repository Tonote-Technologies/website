...
const FAQs = [{
  ...
  list: {
    type: 'unordered',
    content: ['Driver’s license', 'International passport', 'National identity card', 'Voters card']
  }
}, {
  id: 9,
  ...
  list: {
    type: 'unordered',
    content: ['It exceeds 50MB or contains more than 500 pages', 'It is a .doc, .xls or .ppt. We support .pdf, …..(All document types should be accepted but will automatically convert to PDF.']
  }
}, {
  id: 18,
  ...
  list: {
    type: 'ordered',
    content: ['Log in to your ToNote account', 'Search for the document in the search box', 'You can download a document if it is available in your locker']
  }
}, {
  id: 21,
  ...
  list: {
    type: 'ordered',
    content: ['Log in to your ToNote account', 'Search for the document in the search box', 'You can download a document if it is available in your locker', 'ToNote encourages a greener environment and advises users to share documents electronically to trusted recipients as opposed to printing paper copies.']
  }
}, {
  id: 22,
  ...
  list: {
    type: 'ordered',
    content: ['Visit the ‘ToNote for Notaries Public’ tab on our web platform', 'Sign up and input the required personal information', 'Upload your ID and Notary certificate or Sworn oath of office documentation', 'Once your credentials are verified you will be alerted and you can take part in a short Remote Online Notarisation training course and assessment', 'Digitise your notary stamp, seal and signature automatically', 'Ensure you have an internet enabled device with audio and video capabilities', 'Select your preferred schedule for notary sessions', 'Start earning']
  }
}, {
  id: 23,
