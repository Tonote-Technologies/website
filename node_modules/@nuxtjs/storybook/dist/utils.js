...
function loadFile(rootDir, file) {
    return (0, jiti_1.default)(rootDir)(file) || {};
}
...
function compileTemplate(src, destination, templateVars) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const templateFunction = (0, template_1.default)(fileContent);
...
function ensureCoreJs3(rootDir) {
    const corejsVersion = Number.parseInt((0, create_require_1.default)(rootDir)('core-js/package.json').version.split('.')[0]);
    if (corejsVersion < 3) {
        let nuxtVersion = '';
        try {
            nuxtVersion = ((0, create_require_1.default)(rootDir)('nuxt/package.json').version);
        }
        catch (_a) { }
        try {
            nuxtVersion = ((0, create_require_1.default)(rootDir)('nuxt-edge/package.json').version);
        }
        catch (_b) { }
