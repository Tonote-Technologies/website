...
function _run() {
    ...
    switch (mode) {
        case 'build':
            return (0, index_1.build)(Object.assign({ rootDir,
                mode }, (0, utils_1.normalizeFlags)(flags)));
        case 'eject':
            return (0, index_1.eject)(Object.assign({ rootDir, mode: 'dev' }, (0, utils_1.normalizeFlags)(flags)));
        case 'dev':
            ...
            return (0, index_1.start)(Object.assign({ rootDir,
                mode }, (0, utils_1.normalizeFlags)(flags)));
        default:
