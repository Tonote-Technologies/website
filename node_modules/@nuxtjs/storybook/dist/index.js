...
function build(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, server_1.buildStatic)(buildOptions);
    });
}
exports.build = build;
function start(options) {
    return __awaiter(this, void 0, void 0, function* () {
        const buildOptions = yield getStorybookConfig(options);
        (0, server_1.buildDev)(buildOptions);
    });
}
exports.start = start;
function getStorybookConfig(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        nuxtStorybookConfig.webpackFinal = (config, options) => {
            config = (0, webpack_1.getWebpackConfig)(config, options);
...
function buildNuxt(options) {
    return __awaiter(this, void 0, void 0, function* () {
        (0, utils_1.ensureCoreJs3)(options.rootDir);
        const buildDir = path_1.default.resolve(options.rootDir, '.nuxt-storybook');
        const { loadNuxt, getBuilder } = (0, utils_1.requireMaybeEdge)('nuxt');
        ...
        if (fs_extra_1.default.existsSync(tsConfigPath)) {
            const tsNode = (0, utils_1.requireTsNodeOrFail)();
            tsNode.register({
...
function eject(options) {
    ...
    (0, utils_1.compileTemplate)(path_1.default.resolve(templatesRoot, 'eject', 'main.js'), path_1.default.join(configDir, 'main.js'), {});
    (0, utils_1.compileTemplate)(path_1.default.resolve(templatesRoot, 'eject', 'middleware.js'), path_1.default.join(configDir, 'middleware.js'), {});
    (0, utils_1.compileTemplate)(path_1.default.resolve(templatesRoot, 'eject', 'preview.js'), path_1.default.join(configDir, 'preview.js'), {});
}
exports.eject = eject;
